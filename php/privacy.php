...
<div class="col-lg-12 columnBlockLayout" style="flex-grow: 1; display: flex; flex-direction: column; min-width: 300px; margin: 0px; padding: 10px;">
      ...
      <ul>
        <li>name, gender, date of birth, martial status, next of kin, contact details (such as email address and telephone numbers)</li>
        <li>profession, occupation or job title</li>
        <li>business address, mailing or street addresses</li>
        <li>government related identifiers in order to verify your identity (e.g. driver licence/ birth certificate);</li>
        <li>vehicle information where a Telematics unit has been fitted (e.g., driving speeds, driving patterns and locations, fuel fills and purpose of travel);</li>
        <li>information about your financial affairs and your transactions with us or third parties;</li>
        <li>information you provide through our website, social media or any other IT platform in which we operate our business from (see section 5). This also includes cookies that collect users’ internet activity (refer to section 5); and,</li>
        <li>information that is collected through our third parties, such as customer surveys</li>
      ...
      <ul>
        <li>Within the context of employment or seeking employment (please refer to note below *)</li>
        <li>Uploading client’s specified personal information of users into our client portal</li>
        <li>Driving a vehicle fitted with a telematics unit</li>
        <li>Visiting or accessing our online services</li>
        <li>Attending a NextFleet event or an event where we are represented at a trade show;</li>
        <li>Requesting a brochure, joining a mailing list or requesting to be contacted for further information through third parties, such as:
          <ul>
            <li>credit reporting agencies</li>
            <li>law enforcement agencies and other government entities</li>
            <li>marketing research organisation</li>
            <li>labour hire agencies</li>
            <li>other related entities </li>
          </ul>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>to provide to government agencies and law enforcement authorities</li>
        <li>to provide to the operators of toll facilities</li>
        <li>to provide our customers/ managers with NextFleet, vehicle performance data (via telematics) that can be used to help monitor and improve the performance and fuel economy of a lease/company vehicle</li>
        <li>to record information regarding products purchased from us and to provide further services to you, such as product warranties and guarantees, and repair or replacement of products</li>
        <li>to assist in providing better products and services to you by tailoring them to meet your needs</li>
        <li>to provide you with access to protected areas of our website</li>
        <li>to assess the performance of our website and to improve the operation of our website</li>
        <li>to keep our websites and other online presence relevant and of interest to you, for direct marketing including promotions, newsletters and competitions, to show you advertising and information that is most relevant to you and your interests, and to carry out analysis of market activity, market research and surveys</li>
        ...
        <li>for contracting with you</li>
        <li>if you are applying for employment with us, to consider your application for a particular role, and for a limited period to determine whether you have previously applied to use and to assess your suitability for other employment opportunities.</li>
        ...
        <li>fraud prevention or debt recovery</li>
        <li>to provide to (or collect from) insurers and their associated entities such investigators and loss adjusters</li>
        <li>to comply with any law, rule, regulation, lawful and binding determination, decision or direction of a regulator, or in co-operation with any governmental authority of any country; and</li>
      ...
      <ul>
        <li>restricting access to your personal information to only those who need to use it for the relevant purpose;</li>
        <li>transferring your personal information only in encrypted form;</li>
        <li>preventing unauthorised access to IT systems by using firewalls; and</li>
        <li>permanent monitoring of IT systems to detect and stop misuse of personal information.</li>
      </ul>
      ...
      <ul>
        ...
        <li>third party contractors and providers of goods and services, such as courier and delivery companies, marketing and promotion companies, training and training certification agencies, web analytics services, business support services, and information technology service providers</li>
        <li>financiers and rating agencies for the purpose of the funding, refinancing, sale or securitization associated due diligence and review of the products and related services provided to you</li>
        <li>market research companies who undertake customer surveys for us</li>
        <li>professional service firms providing services to us, such as legal or accountancy services</li>
        <li>law enforcement agencies or regulatory agencies where required or authorised by or under a law or a court or tribunal or as necessary to manage any claim or issue</li>
        <li>any entity where required or authorised by or under a law or a court or tribunal; and</li>
        <li>any other recipient which is notified to you at the time of collection or that you otherwise authorise.</li>
      </ul>
      <p>9.2 Disclosing your Personal Information overseas:</p>
      ...
      <p>We may refuse to provide the information you have requested. Reasons may include, however not limited to, not providing verification of your identification, we do not hold the information, access cannot be given in the manner it has been requested or where access is prohibited or restricted by law or a court order.</p>
      <p>If this is the case, we will write to you within a reasonable period and provide reasons for the refusal (except where it be unreasonable to do so), the mechanism to raise a complaint and any other regulations as required under the Privacy Act.</p>
      <p>12.2 Correction</p>
      <p>You also have the right to request that we correct any inaccurate personal information we hold about you, subject to some exceptions. If you wish to correct the personal information we hold about you, please contact us using the contact details provided below.</p>
      <p>If we do not agree to amend your personal information, we will inform you of our decision within a reasonable period. If you wish to complain about this outcome or to attach a statement to your record that you believe the personal information we hold about you is inaccurate, out-of-date, incomplete, irrelevant or misleading, please see our complaints procedure below.</p>
      <p>12.3 Deletion</p>
      ...
      <p>Some examples of data breaches include, loss of paper records with identifiable information on them, theft of devices, such as laptops and storage devices, personal information being emailed to the wrong person, personal information disclosed as a result of inadequate verification process, scammers or security incident.</p>
      ...
      <p>Privacy Officer </br> NextFleet Australia Pty Ltd </p> 
      <p>Level 1, Building 5 </br>747 Lytton Road, </br> Murarrie QLD 4172 </br>PO Box 63 Cannon Hill 4170</p>
...
<?php
  ...
  file_put_contents(__DIR__ . '/../privacy.html', $output);
