...
<div class="col-lg-12 columnBlockLayout" style="flex-grow: 1; display: flex; flex-direction: column; min-width: 300px; margin: 0px; padding: 10px;">
      ...
      <ul>
        ...
        <li>Uploading client’s specified personal information of users int</li>
        <li>our client portal</li>
        ...
        <li>Requesting a brochure, joining a mailing list or requesting t</li>
        <li>be contacted for further information</li>
        <li>Through third parties, such as <ul>
      ...
      <p>Under APP 12, we may refuse if the information you have requested. Reasons may include, however not limited to, not providing verification of your identification, we do not hold the information, access cannot be given in the manner it has been requested or where access is prohibited or restricted by law or a court order.</p>
...
<?php
  ...
  file_put_contents(__DIR__ . '/../parivacy.html', $output);
