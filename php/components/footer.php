...
$services_links = [
    ...
    ['text' => 'Sale & Leaseback', 'url' => '/sales-leaseback.html']
];
...
$drive_links = [
    ...
    ['text' => 'My Drive App', 'url' => '/mydrive.html']
];
?>
  ...
  <div class="container">
    <div class="row g-5">
      <div class="col-md-2 text-gray">
        <div class="mb-4">
          <a href="/" class="footer-logo"><img src="images/nextfleet-logo-footer.jpg" alt="" width="200"></a>
        </div>
