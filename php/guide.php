  ...
  <div class="body-content">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-12">
                    <a href="https://www.nextfleet.net.au/Resources/Drivers-Resources/myDrive-Driver-Guide.pdf" class="text-uppercase fw-bold fs-6 text-white btn btn-primary w-100 d-flex justify-content-center">
                        <div class="d-flex align-items-center gap-3">
                            <i class="fa fa-download" aria-hidden="true"></i>
                            <div> Download Driver Guide</div>
                        </div>
                    </a>
            </div>
        </div>
