    ...
    <?php loadComponent("header");?>
        <div class="grid g-5">
                ...
                <section class="bg-white pt-5 pb-5">
                    ...
                    <section id="fontawesome" class="mb-5">
                        <h2 class="mb-3">Font Awesome Icons</h2>
                        <p class="text-muted">Examples of commonly used icons. Use <code>&lt;i class="fa fa-icon-name"&gt;&lt;/i&gt;</code> or <code>&lt;i class="fas fa-icon-name"&gt;&lt;/i&gt;</code> depending on your version.</p>
                        ...
                        <div class="col-6 col-md-3 text-center">
                            ...
                            <div><code>fa-home</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-search fa-2x mb-2"></i>
                            <div><code>fa-search</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-bars fa-2x mb-2"></i>
                            <div><code>fa-bars</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-user fa-2x mb-2"></i>
                            <div><code>fa-user</code></div>
                        </div>
                        </div>
                        ...
                        <div class="col-6 col-md-3 text-center">
                            ...
                            <div><code>fab fa-facebook</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fab fa-twitter fa-2x mb-2"></i>
                            <div><code>fab fa-twitter</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fab fa-instagram fa-2x mb-2"></i>
                            <div><code>fab fa-instagram</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fab fa-linkedin fa-2x mb-2"></i>
                            <div><code>fab fa-linkedin</code></div>
                        </div>
                        </div>

                        <!-- Alerts & Status -->
                        <h4 class="mt-5">Alerts & Status</h4>
                        <div class="row g-4">
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-check-circle text-success fa-2x mb-2"></i>
                            <div><code>fa-check-circle</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-exclamation-circle text-warning fa-2x mb-2"></i>
                            <div><code>fa-exclamation-circle</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-times-circle text-danger fa-2x mb-2"></i>
                            <div><code>fa-times-circle</code></div>
                        </div>
                        <div class="col-6 col-md-3 text-center">
                            <i class="fas fa-info-circle text-info fa-2x mb-2"></i>
                            <div><code>fa-info-circle</code></div>
                        </div>
                        </div>
                    </section>
                    </div>
