...
<?php loadComponent("header");?>
    ...
    >
      <div class="row">
        <div class="col-lg-6">
          <div class="pe-7 d-flex flex-column">            
            <h1>Should You Lease or Buy Your Fleet?</h1>
    ...
    <section class="border-top pt-5 pb-5">
      ...
      <div class="row">
        <div class="col-sm-7 m-auto mt-4 mt-sm-0">
            ...
            <div class="mb-3">
                <label for="tel" class="form-label">Contact Phone</label>
                <input type="tel" class="form-control" id="tel" placeholder="Provide a telepone number">
            </div>
